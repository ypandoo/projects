...
public class CompleteSubscribeRecord {
	...
	private boolean isRemissionSubscribe;
	...
	private BigDecimal dimissionAmt;
	...
	public boolean isIsRemissionSubscribe() {
		return isRemissionSubscribe;
	}

	public void setIsRemissionSubscribe(boolean isRemissionSubscribe) {
